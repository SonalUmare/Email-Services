...
public class Registration {
    ...
    public String Register()
    {
        ...
        if(emailid.matches("(.*)[0-9](.*)") && ((emailid.matches("(.*)[a-z](.*)") || (emailid.matches("(.*)[A-Z](.*)")) )))
        {
        ...
        //final String DB_URL = "jdbc:mysql://localhost:3306/umares3563";
        try
        {
            
            //conn = DriverManager.getConnection(DB_URL, "root" , "sonaljava@123");
